...
@portal_v1.route('/college/register', methods=['POST', 'GET'])
@jwt_required
@registrar_required
def college_head_signup():
    """The registrar can add a new college head."""
    ...
    response = UsersModel(firstname, lastname, surname,
                          admission_no, gender, email, password).save_college_head()
