...
class ChecklistModel(Database):
    ...
    def __init__(self, admission_no=None, department_name=None,
                 ...
                 campus_id=None, hostel_name=None, stream_name=None, created_on=None):
        super().__init__()
    ...
    def save(self):
        """Fill checklist form."""
        self.curr.execute(
            ''' INSERT INTO checklist(student, department, course, certificate,\
            year, campus, hostel, class_stream, created_on)\
            VALUES('{}','{}','{}','{}','{}','{}','{}','{}','{}')
            RETURNING student, department, course, certificate, year, campus,\
            hostel, class_stream, created_on'''.format(self.admission_no,
    ...
    def update(self, checklist_id, department_name, course_name,
               certificate_id, year_id, campus_id, hostel_name):
        """Update checklist by id."""
        self.curr.execute(
            """UPDATE checklist SET department='{}', course='{}',\
            certificate='{}', year='{}', campus='{}', hostel='{}'\
            WHERE checklist_id={} RETURNING department, course, certificate,\
            year, campus, hostel""".format(checklist_id, department_name,
                                           course_name, certificate_id,
                                           year_id, campus_id, hostel_name))
        response = self.curr.fetchone()
        self.conn.commit()
        self.curr.close()
        return response
