...
from utils.v1.dummy.departments import new_department, department_name_exists, invalid_department_name_key,\
...
class TestDepartments(BaseTest):
    ...
    def test_add_department(self):
        ...
        response = self.client.post('/api/v1/departments', data=json.dumps(new_department),
                                    content_type='application/json', headers=self.get_college_head_token())
    ...
    def test_department_name_exists(self):
        ...
        self.client.post('/api/v1/departments', data=json.dumps(new_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        response = self.client.post('/api/v1/departments', data=json.dumps(department_name_exists),
                                     content_type='application/json', headers=self.get_college_head_token())
        result = json.loads(response.data.decode())
    ...
    def test_update_department(self):
        ...
        self.client.post('/api/v1/departments', data=json.dumps(new_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        response = self.client.put('/api/v1/departments/1', data=json.dumps(update_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        result = json.loads(response.data.decode())
    ...
    def test_update_department_keys(self):
        ...
        self.client.post('/api/v1/departments', data=json.dumps(new_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        response = self.client.put('/api/v1/departments/1', data=json.dumps(updated_department_keys),
                                    content_type='application/json', headers=self.get_college_head_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid department_name key')
        assert response.status_code == 400
    ...
    def test_update_department_name_exists(self):
        ...
        self.client.post('/api/v1/departments', data=json.dumps(new_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        response = self.client.put('/api/v1/departments/1', data=json.dumps(update_department_name_exists),
                                    content_type='application/json', headers=self.get_college_head_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
                         'mathematics department already exists')
    ...
    def test_update_non_existing_department(self):
        ...
        self.client.post('/api/v1/departments', data=json.dumps(new_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        response = self.client.put('/api/v1/departments/100', data=json.dumps(update_department),
                                    content_type='application/json', headers=self.get_college_head_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Department not found')
        assert response.status_code == 404
