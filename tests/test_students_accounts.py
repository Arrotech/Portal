...
from utils.v1.dummy.students_accounts import email_already_exists,\
    new_student_login, new_student_account, wrong_firstname,\
    wrong_lastname, reset_email, reset_unexisting_email,\
    wrong_surname, invalid_student_account_keys, invalid_login_password,\
    admission_already_exists,\
    invalid_email_format, student_invalid_login_email, password_length,\
    new_student_account_invalid_email_format
...
class TestUsersAccount(BaseTest):
    ...
    def test_email_format_when_requesting_password_reset_link(self):
        """Test email format when requesting for password reset link."""
        self.client.post(
            '/api/v1/students/register', data=json.dumps(new_student_account),
            content_type='application/json',
            headers=self.get_admin_token())
        response = self.client.post(
            '/api/v1/reset', data=json.dumps(invalid_email_format),
            content_type='application/json',
    ...
    def test_login_password(self):
        ...
        self.client.post(
            ...
            headers=self.get_admin_token())
        response = self.client.post(
            '/api/v1/students/login', data=json.dumps(invalid_login_password),
            content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_get_access_token(self):
        """A user can get the access token using the refresh token."""
        response = self.client.post(
    ...
    def test_protected_routes(self):
        ...
        response = self.client.get(
            '/api/v1/users/protected', content_type='application/json',
            headers=self.get_token())
        assert response.status_code == 200

    def test_get_user_by_admission_number(self):
        """A user can get all his/her account informmation."""
        self.client.post(
            '/api/v1/students/register', data=json.dumps(new_student_account),
            content_type='application/json',
            headers=self.get_admin_token())
        response = self.client.get(
            '/api/v1/students/users/NJCF4001', content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_get_user_by_id(self):
        """A user can get all his/her account information with the ID."""
        response = self.client.get(
            '/api/v1/students/users/1', content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'successfully retrieved')
        assert response.status_code == 200
    ...
    def test_get_non_existing_user_by_id(self):
        ...
        response = self.client.get(
            '/api/v1/students/users/10', content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_the_format_of_create_account_json_keys_for_the_student(self):
        ...
        response = self.client.post(
            ...
            data=json.dumps(invalid_student_account_keys),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_password_format(self):
        ...
        response = self.client.post(
            '/api/v1/students/register', data=json.dumps(password_length),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
        self.assertEqual(
    ...
    def test_email_exists(self):
        ...
        response = self.client.post(
            '/api/v1/students/register', data=json.dumps(email_already_exists),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_student_login(self):
        ...
        self.client.post(
            ...
            headers=self.get_admin_token())
        response = self.client.post(
            '/api/v1/students/login', data=json.dumps(new_student_login),
            content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_password_reset_email_for_the_student(self):
        """A user gets password reset link if they provide valid email."""
        self.client.post(
            '/api/v1/students/register', data=json.dumps(new_student_account),
            content_type='application/json',
            headers=self.get_admin_token())
        response = self.client.post(
            '/api/v1/reset', data=json.dumps(reset_email),
            content_type='application/json')
        result = json.loads(response.data.decode())
    ...
    def test_student_invalid_email_login(self):
        ...
        response = self.client.post(
            ...
            data=json.dumps(student_invalid_login_email),
            content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid Email or Password')
    ...
    def test_wrong_firstname(self):
        """An admin cannot add a student with the wrong firstname format."""
        response = self.client.post(
            '/api/v1/students/register', data=json.dumps(wrong_firstname),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_lastname(self):
        """An admin cannot add a student with the wrong lastname format."""
        response = self.client.post(
            '/api/v1/students/register', data=json.dumps(wrong_lastname),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_surname(self):
        """An admin cannot add a student with the wrong surname format."""
        response = self.client.post(
            '/api/v1/students/register', data=json.dumps(wrong_surname),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_invalid_email_format(self):
        ...
        response = self.client.post(
            '/api/v1/students/register',
            data=json.dumps(new_student_account_invalid_email_format),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid Email Format!')
    ...
    def test_send_reset_unexisting_email(self):
        ...
        self.client.post(
            '/api/v1/students/register',
            data=json.dumps(new_student_account),
            content_type='application/json',
            headers=self.get_admin_token())
        response = self.client.post(
            '/api/v1/reset', data=json.dumps(reset_unexisting_email),
            content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
