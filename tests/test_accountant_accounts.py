...
from utils.v1.dummy.accountant_accounts import admission_already_exists,\
    email_already_exists, new_accountant_account, new_accountant_login,\
    invalid_accountant_account_keys, wrong_firstname, wrong_lastname,\
    wrong_surname, invalid_email_format, password_length, invalid_password,\
...
class TestUsersAccount(BaseTest):
    ...
    def test_password_format(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/register', data=json.dumps(password_length),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(
    ...
    def test_email_exists(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/register',
            data=json.dumps(email_already_exists),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_the_format_of_create_account_json_keys_for_the_accountant(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/register',
            data=json.dumps(invalid_accountant_account_keys),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_accountant_login(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/accountant/login', data=json.dumps(new_accountant_login),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_accountant_invalid_email_login(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/login', data=json.dumps(invalid_password),
            content_type='application/json',
            headers=self.get_admin_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid Email or Password')
    ...
    def test_wrong_firstname(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/register', data=json.dumps(wrong_firstname),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_lastname(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/register', data=json.dumps(wrong_lastname),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_surname(self):
        ...
        response = self.client.post(
            '/api/v1/accountant/register', data=json.dumps(wrong_surname),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
