...
from utils.v1.dummy.academic_year import new_academic_year, academic_year_keys, update_year, update_year_keys
...
class TestacademicYear(BaseTest):
    ...
    def test_add_academic_year(self):
        ...
        response = self.client.post('/api/v1/year', data=json.dumps(new_academic_year),
    ...
    def test_add_academic_year_keys(self):
        ...
        response = self.client.post('/api/v1/year', data=json.dumps(academic_year_keys),
                                    content_type='application/json', headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_get_years(self):
        ...
        self.client.post('/api/v1/year', data=json.dumps(new_academic_year),
                                    content_type='application/json', headers=self.get_admin_token())
        response = self.client.get(
            '/api/v1/year', content_type='application/json', headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_get_year(self):
        ...
        self.client.post('/api/v1/year', data=json.dumps(new_academic_year),
                                    content_type='application/json', headers=self.get_admin_token())
        response = self.client.get(
            '/api/v1/year/1', content_type='application/json', headers=self.get_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_get_non_existing_year(self):
        ...
        self.client.post('/api/v1/year', data=json.dumps(new_academic_year),
                                    content_type='application/json', headers=self.get_admin_token())
        response = self.client.get(
            '/api/v1/year/100', content_type='application/json', headers=self.get_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
                         'Year not found')
    ...
    def test_update_year(self):
        ...
        self.client.post('/api/v1/year', data=json.dumps(new_academic_year),
                                    content_type='application/json', headers=self.get_admin_token())
        response = self.client.put('/api/v1/year/1', data=json.dumps(update_year),
                                    content_type='application/json', headers=self.get_admin_token())
        result = json.loads(response.data.decode())
    ...
    def test_update_year_keys(self):
        """Test that an admin user cannot update an year with invalid json keys."""
        self.client.post('/api/v1/year', data=json.dumps(new_academic_year),
                                    content_type='application/json', headers=self.get_admin_token())
        response = self.client.put('/api/v1/year/1', data=json.dumps(update_year_keys),
                                    content_type='application/json', headers=self.get_admin_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid year key')
        assert response.status_code == 400
    ...
    def test_update_non_existing_year(self):
        ...
        response = self.client.put('/api/v1/year/10', data=json.dumps(update_year),
                                    content_type='application/json', headers=self.get_admin_token())
        result = json.loads(response.data.decode())
