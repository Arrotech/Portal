...
class TestUsersAccount(BaseTest):
    ...
    def test_create_registrar_account(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(new_registrar_account), content_type='application/json',
    ...
    def test_password_format(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(password_length), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(
    ...
    def test_admission_exists(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(admission_already_exists), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_the_format_of_create_account_json_keys_for_the_registrar(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(invalid_admin_account_keys), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_registrar_login(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/staff/login', data=json.dumps(new_registrar_login), content_type='application/json',
    ...
    def test_wrong_firstname(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(wrong_firstname), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_lastname(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(wrong_lastname), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_surname(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(wrong_surname), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_wrong_email(self):
        ...
        response = self.client.post(
            '/api/v1/registrar/register', data=json.dumps(invalid_email_format), content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
