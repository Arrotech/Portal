...
from utils.v1.dummy.certificates import new_certificate, certificate_keys,\
    certificate_name_restrictions, update_certificate,\
    update_certificate_keys, update_certificate_name_restrictions
...
class TestCertificates(BaseTest):
    ...
    def test_add_certificate_keys(self):
        """An admin cannot add a new certificate with invalid json keys."""
        response = self.client.post(
    ...
    def test_add_certificate_name_restrictions(self):
        """An admin cannot add a new certificate with invalid certificate."""
        response = self.client.post(
            '/api/v1/certificates',
    ...
    def test_update_certificate_keys(self):
        """An admin cannot update a certificate with invalid json keys."""
        self.client.post(
            '/api/v1/certificates', data=json.dumps(new_certificate),
            content_type='application/json',
            headers=self.get_registrar_token())
    ...
    def test_update_certificate_name_restrictions(self):
        """An admin cannot update a certificate with invalid certificate."""
        self.client.post(
            '/api/v1/certificates', data=json.dumps(new_certificate),
            content_type='application/json',
            headers=self.get_registrar_token())
