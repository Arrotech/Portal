...
class TestSubjects(BaseTest):
    ...
    def test_add_subjects(self):
        ...
        response = self.client.post(
            '/api/v1/subjects', data=json.dumps(new_subject),
            content_type='application/json',
    ...
    def test_add_subjects_keys(self):
        """Student cannot register for a subject with an invalid key."""
        self.client.post(
            '/api/v1/units', data=json.dumps(new_unit),
            content_type='application/json',
            headers=self.get_department_head_token())
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/subjects', data=json.dumps(new_subject_keys),
            content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_add_subjects_for_unexisting_unit(self):
        """An existing user cannot register for a non existing unit."""
        self.client.post(
            '/api/v1/year', data=json.dumps(new_academic_year),
            content_type='application/json',
            headers=self.get_registrar_token())
    ...
    def test_add_subjects_for_unexisting_user(self):
        """An existing user cannot register for a non existing user."""
        self.client.post(
            '/api/v1/units', data=json.dumps(new_unit),
            content_type='application/json',
            headers=self.get_department_head_token())
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/subjects', data=json.dumps(unexisting_user),
            content_type='application/json',
            headers=self.get_token())
        result = json.loads(response.data.decode())
    ...
    def test_get_subjects_by_admission(self):
        """Student can fetch all subjects that they have registered for."""
        self.client.post(
            '/api/v1/units', data=json.dumps(new_unit),
            content_type='application/json',
            headers=self.get_department_head_token())
    ...
    def test_delete_subject_by_id(self):
        ...
        self.client.post(
            '/api/v1/auth/register', data=json.dumps(new_student_account),
            content_type='application/json',
            headers=self.get_token())
        self.client.post(
            '/api/v1/units', data=json.dumps(new_unit),
