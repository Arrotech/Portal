...
from utils.v1.dummy.campuses import new_campus, campus_keys,\
    campus_name_restrictions, update_campus, update_campus_keys,\
...
class TestCampuses(BaseTest):
    ...
    def test_add_campus_keys(self):
        """An admin cannot add a new campus with invalid json keys."""
        response = self.client.post(
            '/api/v1/campuses', data=json.dumps(campus_keys),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_add_campus_name_restrictions(self):
        """An admin cannot add a new campus with invalid campus name."""
        response = self.client.post(
            '/api/v1/campuses', data=json.dumps(campus_name_restrictions),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_update_campus(self):
        ...
        response = self.client.put(
            '/api/v1/campuses/1', data=json.dumps(update_campus),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_update_campus_keys(self):
        """An admin cannot update existing campus with invalid json keys."""
        self.client.post(
            '/api/v1/campuses', data=json.dumps(new_campus),
            content_type='application/json',
            headers=self.get_registrar_token())
        response = self.client.put(
            '/api/v1/campuses/1', data=json.dumps(update_campus_keys),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_update_campus_name_restrictions(self):
        """An admin cannot update a campus with invalid campus name."""
        self.client.post(
            '/api/v1/campuses', data=json.dumps(campus_name_restrictions),
            content_type='application/json',
            headers=self.get_registrar_token())
        response = self.client.put(
            '/api/v1/campuses/1',
            data=json.dumps(update_campus_name_restrictions),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_update_non_existing_campus(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.put(
            '/api/v1/campuses/100', data=json.dumps(update_campus),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
