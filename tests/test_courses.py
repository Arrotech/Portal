...
from utils.v1.dummy.courses import new_course, add_course_keys,\
    add_non_exisitng_department, course_name_exists, update_course,\
    update_course_name_exists, update_course_keys
...
class TestCourses(BaseTest):
    ...
    def test_add_course_keys(self):
        ...
        self.client.post(
            ...
            headers=self.get_college_head_token())
        response = self.client.post(
            '/api/v1/courses', data=json.dumps(add_course_keys),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_add_course_for_non_existing_department(self):
        """An admin cannot add a course for non existing department."""
        self.client.post(
            '/api/v1/departments', data=json.dumps(new_department),
            content_type='application/json',
            headers=self.get_college_head_token())
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/courses', data=json.dumps(add_non_exisitng_department),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_add_course_for_already_existing_course_name(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.post(
            '/api/v1/courses', data=json.dumps(course_name_exists),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_edit_course_by_id(self):
        ...
        response = self.client.put(
            '/api/v1/courses/1', data=json.dumps(update_course),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
    ...
    def test_edit_course_by_id_keys(self):
        """An admin cannot edit course by id with an invalid json key."""
        self.client.post(
            '/api/v1/departments', data=json.dumps(new_department),
            content_type='application/json',
            headers=self.get_college_head_token())
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.put(
            '/api/v1/courses/1', data=json.dumps(update_course_keys),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Invalid course_name key')
    ...
    def test_edit_existing_course_name(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.put(
            '/api/v1/courses/1', data=json.dumps(update_course_name_exists),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'],
    ...
    def test_edit_non_existing_course(self):
        ...
        self.client.post(
            ...
            headers=self.get_registrar_token())
        response = self.client.put(
            '/api/v1/courses/100', data=json.dumps(update_course),
            content_type='application/json',
            headers=self.get_registrar_token())
        result = json.loads(response.data.decode())
        self.assertEqual(result['message'], 'Course not found')
