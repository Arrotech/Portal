...
Revision ID: e4c639207451
Revises: 0eaad289e486
Create Date: 2021-01-11 22:05:28.381580
...
revision = 'e4c639207451'
down_revision = '0eaad289e486'
branch_labels = None
depends_on = None
...
def downgrade():
    ...
    sa.PrimaryKeyConstraint('student', 'unit', name='subjects_pkey'),
    sa.UniqueConstraint('subject_id', name='subjects_subject_id_key')
    )
    op.create_table('certificates',
    sa.Column('certificate_id', sa.INTEGER(), server_default=sa.text("nextval('certificates_certificate_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.UniqueConstraint('unit_name', name='units_unit_name_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.Column('created_on', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.UniqueConstraint('year_id', name='academic_year_year_id_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.PrimaryKeyConstraint('department', name='courses_pkey'),
    sa.UniqueConstraint('course_name', name='courses_course_name_key'),
    postgresql_ignore_search_path=False
    )
    op.create_table('institutions',
    sa.Column('institution_id', sa.INTEGER(), server_default=sa.text("nextval('institutions_institution_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.UniqueConstraint('institution_name', name='institutions_institution_name_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.PrimaryKeyConstraint('student', name='fees_pkey'),
    sa.UniqueConstraint('fee_id', name='fees_fee_id_key')
    )
    op.create_table('departments',
    sa.Column('department_id', sa.INTEGER(), server_default=sa.text("nextval('departments_department_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.PrimaryKeyConstraint('student', 'department', 'course', 'certificate', 'year', 'campus', 'hostel', name='checklist_pkey'),
    sa.UniqueConstraint('checklist_id', name='checklist_checklist_id_key')
    )
    ...
    sa.PrimaryKeyConstraint('student', 'institution', 'campus', 'certificate', 'department', 'course', name='apply_course_pkey'),
    sa.UniqueConstraint('application_id', name='apply_course_application_id_key')
    )
    ...
    sa.UniqueConstraint('exam_id', name='exams_exam_id_key')
    )
    ...
    sa.PrimaryKeyConstraint('student', name='library_pkey'),
    sa.UniqueConstraint('book_id', name='library_book_id_key')
    )
    op.create_table('hostels',
    sa.Column('hostel_id', sa.INTEGER(), server_default=sa.text("nextval('hostels_hostel_id_seq'::regclass)"), autoincrement=True, nullable=False),
    ...
    sa.Column('created_on', postgresql.TIMESTAMP(), autoincrement=False, nullable=True),
    sa.PrimaryKeyConstraint('hostel_id', name='hostels_pkey'),
    sa.UniqueConstraint('hostel_name', name='hostels_hostel_name_key'),
    postgresql_ignore_search_path=False
    )
    ...
    sa.PrimaryKeyConstraint('student', 'hostel', name='accommodation_pkey'),
    sa.UniqueConstraint('accommodation_id', name='accommodation_accommodation_id_key')
    )
    ...
    sa.UniqueConstraint('admission_no', name='users_admission_no_key')
    )
    # ### end Alembic commands ###
